...
class _BrowserPageState extends State<BrowserPage> {
  ...
  Future<void> _pickDirectory(BuildContext context) async {
    ...
    objectHandleProv.path = newDirectory.toString();

    final storage = new FlutterSecureStorage();
    await storage.write(
        key: objectHandleProv.pathKey, value: objectHandleProv.path);
  ...
  void initState() {
    super.initState();
    objectHandleProv = Provider.of<BrowserModel>(context, listen: false);
    getPath();
  }
  ...
  Future<void> getPath() async {
    final storage = new FlutterSecureStorage();
    try {
      objectHandleProv.path = await storage.read(key: objectHandleProv.pathKey);
    } catch (e) {
      print("error $e");
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<BrowserModel>(builder: (context, data, child) {
      return Container(
        color: Colors.teal,
        child: Padding(
              ...
              Row(
                ...
                children: [
                  ElevatedButton.icon(
                    ...
                    label: Text("Get a list of photos"),
                    onPressed: () {
                  ...
                  Text(
                    objectHandleProv.myHandlesList.length.toString() +
                        " photos",
                    style: TextStyle(
                          ...
                          return GestureDetector(
                              ...
                              onTap: () {
                                ...
                                objectHandleProv.handleDownloading =
                                    objectHandleProv
                                        .myHandlesList[index].handle;
                                objectHandleProv.displayThumb(objectHandleProv
                                    .myHandlesList[index].handle);
                                widget.downloadThumb(objectHandleProv
                                    .myHandlesList[index].handle);
                              });
                        },
                      ),
